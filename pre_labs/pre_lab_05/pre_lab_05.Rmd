...
**Answer**
"W." It is reading is as a capital W and with a period. Also, everything is capitalized which might actually be a good thing since we want uniformity. There are also several mispellings of words, or some recipient names are spelled the same and have one thing that differnentiates them, like a period, or an "S" at the end. Basiacally a lof of problems with consisteny.
```{r}
...
**Answer** Le Diplomate is now listed once, and Joe's Seafood has a comma in it now. 
...
**Answer** Millars and Co. now is standardized with a period at the end. "We the Pizza is now only spelled as such and not as "Pizza, we the. Hilton Washington now reads as Washington Hilton. 
...
**Answer** Not that big of a change, or any change at all except for standardization across the names but not to a really big extent. You would still need to go through to make sure things are cleaned. 
...
```{r}
dc_food_edited<-read.csv("data/dc-food-csv_edited.csv")
