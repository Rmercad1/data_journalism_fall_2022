...
**Answer**54,247 rows and 24 variables
...
**Answer** Beth Hansher, Homemaker. Org is listed as "NA" and employer is listed as "requested."
...
**Answer** The number of contributions per day.
...
**Answer** The code re-ordered the days from highest number of contributions in descending order.
...
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** The code re-aranged the results to show where the total contributions are earmarked towards. Which org got what. 
...
```
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** It is now showing the exact dollar amount from those contributions. 
...
**Answer** You have a lot more data avaiable now, what this shows is a significant amount of money going towards GOP pacs or candidates.
...
**Answer** Interestingly, or perhaps not so interesting as it is obvious, the cities that gave the most contributions are the ones in Maryland with the highest per capita income, such as the rich cities in Montgomery County. 
