...
```{r echo=FALSE}
census_api_key("732f941b8f4f496ad75f0c33522d418c863c3359", install=TRUE)
```
...
**Answer** It's Howard County, which, as a Montgomery County resident, I am insulted!
...
Yes, it is. Montgomery's is pretty tight, but when I look at Calvert, it is a much larger margin. My thinking is that since Montgomery is mostly rich suburbs, it would have *somewhat* similar averages among its residents, while Calvert County has many farms and agriculture towns with people most likely with low incomes, and also some rich suburban towns, which skews its incomes among its population. 

Is the difference between Howard and everyone else significant?
**Answer**

Yes and no. I thought Montgomery would take the place as the richest county, but it is Howard. It is significant in the fact that its so far away from the others, but not significant when you understand who lives there. Howard County is home to very rich Marylanders who live in large homes. High incomes among the population there isn't a surprise.
...
**Answer**
It looks like Carloline County had a decrease. The min in 2010 was 56740 while the min in 2020 was less, at 54827.
...
**Answer** The first zip that shows up with an estimate below 50,000 is 21539, which is a zip near Frostburg in Western Maryland, a rural place with many low-income residents. The next one, 21767, is located near Hagerstown, which is a pretty large place for Western Maryland standards.
...
**Answer** The top zip, 21723, is Cooksville, MD in Howard County,which may answer why Howard County is so far skewed when it comes to incomes compared to other countries. The second one is near Glen Echo in Montgomery County near the DC palisades, this makes sense since a lot of well to do people live there. And the last one, 20854, is Potomac, which is not surprising at all. My only question from these is who lives in Cooksville to cause this one zipcode to be so rich? 