...
**Answer** One row is an extension of the name "Wilson Bend." During the transfer the name "Bend" got put into one row, that needs to be changed. That row is also just "NA." The voters column is listed as a character, and so is the turnout column. Finally, the row labelled "Jurisdiction wide" is an entirely "NA" row. 
...
**Answer** It has 21 rows now compared to 23. The explanation point removed what we didn't need. 
