...
**Answer** Yes they do, the columns are mainly political parties. 
...
**Answer** There are only two rows. It doesn't show information from the voter registration files, which would be useful. 
...
**Answer** It has to do with how you categorize "Counties" in the file.
...
**Answer** PG County with a 61% black population with 78% democrats.
...
**Answer** Howard County with an asian population of 19% and 52% democrats.
